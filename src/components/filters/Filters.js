            ...
            <section className="row filters">
                <div className="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div className="row">
                        ...
                        <div className="col-12 col-sm-5 col-md-5 col-lg-5 text-center selected">{this.props.selectCount ? this.props.selectCount : "Nothing"} Selected <img src={require('../../content/icons/caret-blue-down.svg')} alt="plus" /></div>
