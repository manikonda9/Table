        ...
        return (
            <div className="pagination row">
                ...
                <div className="col-4 text-center">
                    ...
                    <span> {this.props.currentPage} of {this.props.numberOfPages} </span>
                    <span>{this.props.currentPage === this.props.numberOfPages ? <img src={require('../../content/icons/gray-right.svg')} alt="plus" /> : <img src={require('../../content/icons/right.svg')} onClick={this.props.changeCurrentPage.bind(this, "right")} alt="plus" />}</span>
                </div>
